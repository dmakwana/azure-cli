...
register_cli_argument('documentdb database list', 'account_name', completer=None)
register_cli_argument('documentdb database list', 'resource_group_name', help="name of the resource group")